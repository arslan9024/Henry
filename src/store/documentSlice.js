...
export const initialState = {
  ...
  property: {
    ...
    parkingCount: 2,
    propertyType: 'Villa',
    // Source metadata retained from the latest applied Title Deed reference.
    titleDeedMortgageStatus: '',
    titleDeedOwnerName: '',
    titleDeedOwnerNumber: '',
    landRegistrationNo: '',
    titleDeedPurchaseDate: '',
    titleDeedPurchaseAmountAed: '',
    titleDeedCertificateNo: '',
  },
  broker: {
    orn: '',
